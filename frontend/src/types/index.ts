...
export enum EstadoCompra {
	...
	RECHAZADO = "rechazado",
	REEMBOLSO_REQUERIDO = "reembolso_requerido",
	ERROR = "error",
...
export const EstadoTexto: Record<EstadoCompra, string> = {
	...
	[EstadoCompra.PROCESANDO]: "⚙️ Procesando",
	...
	[EstadoCompra.REEMBOLSO_REQUERIDO]: "💰 Reembolso Requerido",
	...
	[EstadoCompra.ERROR_APROBACION]: "⚠️ Error en Aprobación",
	[EstadoCompra.COMPLETADO_SIN_NOTIFICACION]:
		"🔔 Completado sin Notificación",
};
...
export const EstadoColor: Record<EstadoCompra, string> = {
	...
	[EstadoCompra.REEMBOLSO_REQUERIDO]: "bg-amber-100 text-amber-800",
